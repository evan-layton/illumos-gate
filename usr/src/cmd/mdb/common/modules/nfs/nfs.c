...
extern int nfs_stat_dcmd(uintptr_t, uint, int, const mdb_arg_t *);
...
/* NFSv4 clnt */
	...
	{
		"nfs_rnode4find", ":",
		"dump NFSv4 rnodes for given vfsp",
		nfs_rnode4find_dcmd, nfs_rnode4find_help
	},
	{"nfs4_foo", "?[-v]", "dump free open owners for NFSv4 client",
		nfs4_foo_dcmd},
	{"nfs4_oob", "?[-v]", "dump open owners for NFSv4 client",
		nfs4_oob_dcmd},
	{"nfs4_os", "?[-v]", "dump open streams for NFSv4 Client",
		nfs4_os_dcmd},

/* generic commands */
	{"nfs_stat", "?[-csb][-234][-anr] | $[count]", "Print NFS statistics", nfs_stat_dcmd},
	{"nfs_help", "[-dw]", "Show nfs commands", nfs_help_dcmd},
